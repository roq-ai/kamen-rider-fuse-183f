...
import { getKamenRiderImageById } from 'apiSdk/kamen-rider-images';
import { KamenRiderImageInterface } from 'interfaces/kamen-rider-image';

function KamenRiderImageViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Kamen Rider Image Details',
              isCurrent: true,
            },
          ]}
        />
