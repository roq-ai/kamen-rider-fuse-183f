...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'fused_image.count', 'kamen_rider_image.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('fused_image', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'fused_image',
          header: 'Fused Image',
          accessorKey: 'fused_image',
          cell: ({ row: { original: record } }: any) => record?._count?.fused_image,
        }
      : null,
    hasAccess('kamen_rider_image', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'kamen_rider_image',
          header: 'Kamen Rider Image',
          accessorKey: 'kamen_rider_image',
          cell: ({ row: { original: record } }: any) => record?._count?.kamen_rider_image,
        }
      : null,
